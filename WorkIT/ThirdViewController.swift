...
class ThirdViewController: LanguageHolder, UITableViewDataSource, UITableViewDelegate {
...
//    var mainLanguage: String = Constants.englishLangKey
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if (self.player == nil) {
            ...
            loadTranslationData()
            self.player!.setupPlaylistFiles(section: 3, language: self.translateToLanguage, titles: phrases, translations: translations)
        }
